...
export const timelineItems: TimelineItem[] = [
  { type: "run" as const, refId: "run1", createdAtISO: runPosts[0].createdAtISO, orgId: null },
  { type: "event" as const, refId: "event1", createdAtISO: events[0].dateISO, orgId: events[0].orgId },
  { type: "run" as const, refId: "run2", createdAtISO: runPosts[1].createdAtISO, orgId: null },
  { type: "event" as const, refId: "event2", createdAtISO: events[1].dateISO, orgId: events[1].orgId },
  { type: "run" as const, refId: "run3", createdAtISO: runPosts[2].createdAtISO, orgId: null },
  { type: "event" as const, refId: "event3", createdAtISO: events[2].dateISO, orgId: events[2].orgId },
  { type: "run" as const, refId: "run4", createdAtISO: runPosts[3].createdAtISO, orgId: null },
  { type: "event" as const, refId: "event4", createdAtISO: events[3].dateISO, orgId: events[3].orgId },
  { type: "run" as const, refId: "run5", createdAtISO: runPosts[4].createdAtISO, orgId: null },
  { type: "event" as const, refId: "event5", createdAtISO: events[4].dateISO, orgId: events[4].orgId },
  { type: "run" as const, refId: "run6", createdAtISO: runPosts[5].createdAtISO, orgId: null },
  { type: "event" as const, refId: "event6", createdAtISO: events[5].dateISO, orgId: events[5].orgId },
  { type: "run" as const, refId: "run7", createdAtISO: runPosts[6].createdAtISO, orgId: null },
  { type: "run" as const, refId: "run8", createdAtISO: runPosts[7].createdAtISO, orgId: null },
  { type: "run" as const, refId: "run9", createdAtISO: runPosts[8].createdAtISO, orgId: null },
  { type: "run" as const, refId: "run10", createdAtISO: runPosts[9].createdAtISO, orgId: null },
  { type: "run" as const, refId: "run11", createdAtISO: runPosts[10].createdAtISO, orgId: null },
  { type: "run" as const, refId: "run12", createdAtISO: runPosts[11].createdAtISO, orgId: null },
  { type: "run" as const, refId: "run13", createdAtISO: runPosts[12].createdAtISO, orgId: null },
  { type: "run" as const, refId: "run14", createdAtISO: runPosts[13].createdAtISO, orgId: null }
