...
export function RecoveryCodeScreen({ route, navigation }: any) {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      setTimeout(() => navigation.navigate('SignIn'), 800);
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <View style={{ flex: 1, padding: 16, backgroundColor: theme.colors.bg }}>
      ...
      <Text style={{ color: theme.colors.text.muted, marginBottom: 8 }}>
        We emailed you a 6-digit code. Enter it with your email and choose a new password.
      </Text>
      <TextInput
        autoCapitalize="none"
